...
function safeSaveEvents(events: CalendarEvent[]) {
  if (typeof window === "undefined") return;
  try {
  ...
  return (
    <main
      style={{
        ...
        background:
          "linear-gradient(180deg, #ECE0DA 0%, #F1C8CB 50%, #ECE0DA 100%)",
      }}
    >
      <Navbar />

      <div className="flex-1 p-8 md:p-16 relative font-sans text-ma-eggplant">
              ...
              >
                <AnimatePresence initial={false}>
                  {topPriorityItems.map((event) => {
                    const isCompleting = priorityAnimatingIds.includes(
                      event.id,
                    );
          ...
          {selectedDay && (
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.22 }}
                className={`rounded-[3.5rem] w-full max-w-md shadow-2xl border border-ma-sand/20 overflow-hidden flex flex-col min-h-0 ${
                  isDayEmpty ? "h-auto" : "h-[78vh]"
                }`}
                // ✅ ONLY CHANGE YOU ASKED: make popup match chat background vibe
                style={{
                  background:
                    "linear-gradient(180deg, rgba(236, 224, 218, 0.95) 0%, rgba(241, 200, 203, 0.92) 50%, rgba(236, 224, 218, 0.95) 100%)",
                }}
              >
                <style jsx>{`
                  .dayScroll {
                ...
                {/* Header */}
                <div className="shrink-0 px-10 pt-10 pb-6 border-b border-ma-sand/30">
                ...
                {isDayEmpty ? (
                  <div className="px-10 pt-8 pb-10">
                    <div className="bg-white/70 rounded-[2.5rem] p-10 border border-ma-sand/20 text-center opacity-70 italic">
                  ...
                  <div className="flex-1 min-h-0 overflow-hidden">
                    <div className="dayScroll h-full min-h-0 overflow-y-auto overflow-x-hidden px-10 pr-8 pb-10 pt-8 snap-y snap-mandatory">
                      ...
                      >
                        ...
                        {/* bottom gutter to keep scrollbar end clean */}
                        <div className="h-14" />
                      </motion.div>
                    </div>
                  </div>
            ...
            >
              ...
              >
                ...
                <p className="text-sm opacity-60 leading-relaxed mb-10 font-medium">
                  ...
                  <span className="font-bold text-ma-terracotta">
                    10 points
                  </span>
                  .
                  <br />
